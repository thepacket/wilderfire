...
function bindingsFor(v: DumpVar): Env {
  ...
  b.set('__z', { code: 'z_', ty: F, lvalue: true, flag: 'z', decl: 'var z_: f32 = 0.0;' });
  b.set('__px', { code: 'v.x', ty: F, lvalue: true });
  b.set('__py', { code: 'v.y', ty: F, lvalue: true });
  b.set('__pz', { code: 'pz_', ty: F, lvalue: true, flag: 'z', decl: 'var pz_: f32 = 0.0;' });
  ...
  b.set('__z0', { code: '0.0', ty: F, lvalue: false, flag: 'z' });
...
for (const v0 of dump) {
  ...
  const v: DumpVar = ov ? { ...v0, gpuCode: ov.gpuCode ?? v0.gpuCode, gpuFunctions: ov.gpuFunctions ?? v0.gpuFunctions } : v0;
